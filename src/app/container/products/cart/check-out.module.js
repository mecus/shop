System.register(["@angular/core", "@angular/common", "app/modules/material/material.module", "./cart.component", "./cart.side.component", "./cart.total.component"], function (exports_1, context_1) {
    "use strict";
    ...
    var core_1, common_1, material_module_1, cart_component_1, cart_side_component_1, cart_total_component_1, CheckOutModule;
    return {
        setters: [
            function (core_1_1) {
                core_1 = core_1_1;
        ...
        execute: function () {
            CheckOutModule = (function () {
                ...
                CheckOutModule = __decorate([
                    core_1.NgModule({
                        imports: [
                            common_1.CommonModule, material_module_1.MaterialModule
                        ],
            ...
            exports_1("CheckOutModule", CheckOutModule);
        }
    };
});
